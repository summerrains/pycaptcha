...
def set_art_text(background_image: ImageUtil, word: str, font_size: int, point: dict,fill=None) -> None:
    ...
    if fill is None:
        ...
        rgba_image.text((point.get("x"), point.get("y")), word,fill=fill, font=font)
    return None
